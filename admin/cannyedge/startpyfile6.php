...
<script src="../validatadmin/validationcanny.js"></script>
</head>
  ...
  ?>
				...
				<td width="998"   height="600px" valign="top" bgcolor="#414141" style="padding:0px;">
					...
					<table style="border-collapse:collapse;" cellspacing="0"><tr><td width="927" height="80px" colspan="2" align="center" valign="middle">
						 ...
						 <div id="heading">Canny Edge Detection</div>
...
<h3 style="color:#FFFFFF">please click on submit button to perform canny edge detector algorithm</h3>

<table align="center"><tr><td>
<form action="../cannyedge/cannyedge.py" method ="post">

...
<h3 style="color:#FFFFFF">please click on submit button to perform histogram generation of 16 bit imagery</h3>

<table align="center"><tr><td>
<form action="../histogram16/firsthisto16bit.py" method ="post">

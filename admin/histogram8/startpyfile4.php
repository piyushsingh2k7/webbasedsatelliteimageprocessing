...
<script src="../validatadmin/validationhistogram8.js"></script>
</head>
  ...
  ?>
				...
				<td width="998"   height="600px" valign="top" bgcolor="#414141" style="padding:0px;">
					...
					<table style="border-collapse:collapse;" cellspacing="0"><tr><td width="927" height="80px" colspan="2" align="center" valign="middle">
						 ...
						 <div id="heading">histogram generation</div>
...
<h3 style="color:#FFFFFF">please click on submit button to perform histogram generation of 8 bit imagery</h3>

<table align="center"><tr><td>
<form action="../histogram8/firsthisto.py" method ="post">

...
<!--   content... -->
<a href="sobeledge.py"><p align='center' style='color:#FFFFFF;'><h3>Run the program!!! to perform sobel edge detection algorithm</h3>
</p></a>
<iframe src="sobeledge.py" width="100%" height="100"> align= "top" </iframe>
<!--<h3 style="color:#FFFFFF">please click on <>Run the program!!! to perform sobel edge detection algorithm</h3>

<table align="center"><tr><td>
<form action="sobeledge.py" method ="post">
